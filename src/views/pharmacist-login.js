...
import NavigationLinks11 from '../components/navigation-links11'
import './pharmacist-login.css'

const PharmacistLogin = (props) => {
  return (
    <div className="pharmacist-login-container">
      ...
      <div className="pharmacist-login-container1">
        <Link to="/pharmacist-login" className="pharmacist-login-navlink">
          <img
            alt="Rectangle142114"
        ...
        <Link to="/" className="pharmacist-login-navlink1">
          <img
            alt="Rectangle132114"
        ...
        <span className="pharmacist-login-text02">
          <span>USER</span>
        </span>
        <span className="pharmacist-login-text04">
        ...
        <Link
          ...
          className="pharmacist-login-navlink2 button"
        >
          Login
        </Link>
        <input
        ...
        <Link
          ...
          className="pharmacist-login-navlink3 button"
        >
          Register
        </Link>
        <h1 className="pharmacist-login-text06">
      ...
      <div className="pharmacist-login-container2">
        <div className="pharmacist-login-group28">
          <div className="pharmacist-login-frame4">
            <span className="pharmacist-login-text12">
          ...
          <div className="pharmacist-login-group27">
            ...
            <div className="pharmacist-login-frame84">
              <span className="pharmacist-login-text14">
                <span>Medicine Delivery</span>
                <br></br>
                <span> Serv ices</span>
              </span>
              <span className="pharmacist-login-text18">
                <span>
                  Ambulance
                  <span
              ...
              <span className="pharmacist-login-text22">Health Store</span>
            </div>
          </div>
        </div>
        <span className="pharmacist-login-text23">
          <span>
        ...
        <span className="pharmacist-login-text39">
          <span>. . . . .</span>
        </span>
        <div className="pharmacist-login-group24">
          <span className="pharmacist-login-text41">
            <span className="pharmacist-login-text42">Get an Extra </span>
            <span className="pharmacist-login-text43">50%</span>
            <span className="pharmacist-login-text44">
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
                }}
            ...
            <span className="pharmacist-login-text45">Off</span>
            <br className="pharmacist-login-text46"></br>
          </span>
        </div>
        <img
          alt="image63627"
        ...
        <footer className="pharmacist-login-footer">
          <div className="pharmacist-login-container5">
            <nav className="pharmacist-login-nav">
              <span className="pharmacist-login-text47">About</span>
              <span className="pharmacist-login-text48">Features</span>
              <span className="pharmacist-login-text49">Pricing</span>
              <span className="pharmacist-login-text50">Team</span>
              <span className="pharmacist-login-text51">Blog</span>
            </nav>
          </div>
          <div className="pharmacist-login-separator"></div>
          <div className="pharmacist-login-container6">
            <span className="pharmacist-login-text52">
      ...
      <NavigationLinks11 rootClassName="rootClassName8"></NavigationLinks11>
    </div>
  )
}
